...
if(!$mapel){
    echo "<div class='content-body' style='margin-top:-20px;'>
            <div style='background:#ffebee; color:#c62828; padding:20px; border-radius:10px; text-align:center;'>
                <h3><i class='fas fa-exclamation-triangle'></i> Data Tidak Ditemukan!</h3>
                <p>Silakan kembali ke menu Absensi Rekap dan pilih Mata Pelajaran terlebih dahulu.</p>
                <a href='absensi_rekap.php' class='btn-tambah' style='background:#c62828; color:white; padding:10px 20px; text-decoration:none; border-radius:5px;'>Kembali</a>
            </div>
          </div>";
    include 'footer.php';
    exit();
...
<div class="content-body" style="margin-top: -20px;">
    ...
    <div class="welcome-banner" style="background: linear-gradient(to right, #2980b9, #3498db); color: white; padding: 25px; border-radius: 15px; margin-bottom: 25px; box-shadow: 0 10px 20px rgba(41, 128, 185, 0.2);">
        <h2 style="margin: 0; font-size: 24px;"><i class="fas fa-chart-line"></i> Rekap Total Absensi</h2>
    ...
    <a href="absensi_rekap.php?kelas_id=<?php echo $mapel['kelas_id']; ?>&mapel_id=<?php echo $id_mapel; ?>" class="btn-tambah" style="background: #555; color: white; text-decoration: none; padding: 10px 20px; border-radius: 8px; font-weight: bold; display: inline-flex; align-items: center; gap: 8px; margin-bottom: 20px;">
        <i class="fas fa-arrow-left"></i> Kembali ke Harian
    </a>

    <div class="modern-form-card" style="padding: 0; width: 100%; max-width: 100%; overflow: hidden;">
        <div class="table-responsive">
            <table class="table table-striped" style="width: 100%; border-collapse: collapse;">
                <thead style="background: #eaf2f8; color: #2980b9;">
                    <tr>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #f0f0f0;">
                        ...
                        <td style="padding: 15px; font-weight: 600;">
                            <i class="far fa-calendar-alt" style="color: #2980b9; margin-right: 5px;"></i>
